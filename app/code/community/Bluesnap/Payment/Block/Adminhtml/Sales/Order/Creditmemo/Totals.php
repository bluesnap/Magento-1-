...
class  Bluesnap_Payment_Block_Adminhtml_Sales_Order_Creditmemo_Totals extends Mage_Adminhtml_Block_Sales_Order_Creditmemo_Totals
{
    ...
    protected function _initTotals()
    {
        ...
        if (!$this->getSource()->getIsVirtual() && ((float)$this->getSource()->getShippingAmount() || $this->getSource()->getShippingDescription())) {
            $this->_totals['shipping'] = new Varien_Object(array(
                ...
                'bluesnap_value' => $this->getSource()->getBaseShippingAmount(),
        ...
        $this->addTotal(new Varien_Object(array(
            ...
            'bluesnap_value' => $this->getSource()->getBluesnapAdjustmentPositive(),
        ...
        $this->addTotal(new Varien_Object(array(
            ...
            'bluesnap_value' => $this->getSource()->getBluesnapAdjustmentNegative(),
