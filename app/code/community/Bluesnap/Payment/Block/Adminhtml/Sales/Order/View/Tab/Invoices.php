<?php
class Bluesnap_Payment_Block_Adminhtml_Sales_Order_View_Tab_Invoices extends Mage_Adminhtml_Block_Sales_Order_View_Tab_Invoices {
    ...
    */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('bluesnap_grand_total', array(
            'header'    => Mage::helper('customer')->__('Bluesnap Amount'),
